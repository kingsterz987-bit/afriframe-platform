...
const stepHeadings = [
  {
    ...
    sub: "Choose the experience that matches your vision.",
  },
  {
    title: "",
    sub: "",
  },
  {
    ...
    sub: "Select the day we reserve exclusively for you.",
  },
  {
    title: "Choose Your Time",
    sub: "Pick the window that suits your schedule.",
  },
  {
    title: "Your Details",
    sub: "A few essentials so we can prepare properly.",
  },
  {
    title: "Review Booking",
    sub: "Everything in one place before we begin.",
  },
  {
    title: "",
    sub: "",
...
const Booking = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      toast.error(
        "The time you selected is no longer available. Please choose another time."
      );
    }
  }, [
    date,
  ...
  const validateDetails = () => {
    ...
    if (isCustom) {
      ...
      if (!details.medium) {
        next.medium =
          "Choose photography, videography or both";
      }
    }
  ...
  const confirm = async () => {
    ...
    if (
      ...
      toast.error(
        "Please complete your date and time selection."
      );
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="relative overflow-hidden">
        ...
        <section
          ref={topRef}
          className="lux-container relative pb-6 pt-28 text-center md:pt-36"
        >
          <motion.p
            initial={{
              opacity: 0,
                  ...
                  <div className="glass rounded-[26px] p-7 md:p-10">
                    ...
                    {slots.length ? (
                      ...
                      <p className="text-sm italic text-muted-foreground">
                        No times are open for this date.
                ...
                <div className="mx-auto grid max-w-3xl gap-6">
                  ...
                  {isCustom && (
                    <p className="mx-auto -mt-4 max-w-xl text-center text-sm italic text-muted-foreground">
                      This is the beginning of a consultation,
                      not a form. Share as much or as little
                      as you like.
                    </p>
                  )}
                  ...
                  {isCustom ? (
                    <>
                      ...
                      {errors.vision && (
                        <p className="-mt-4 pl-1 text-xs text-destructive">
                          {
                            errors.vision
                          }
                        </p>
              ...
              {step === 5 && (
                <div className="mx-auto max-w-3xl">
                  ...
                  <p className="mt-4 text-center text-xs text-muted-foreground">
                    Final pricing is confirmed after our
                    creative team reviews your request.
                  </p>
              ...
              {step === 6 && (
                <div className="relative mx-auto max-w-2xl overflow-hidden rounded-[28px] px-6 py-14 text-center md:px-12">
                  ...
                  <p className="relative mx-auto mt-5 max-w-md text-muted-foreground">
                    Our creative team is reviewing your request.
